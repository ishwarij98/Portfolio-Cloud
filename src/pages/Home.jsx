...
export default function Home() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-br from-[#1E3A8A] to-[#14B8A6] text-white animate-fade-in">
      <h1 className="text-5xl font-bold mb-2 tracking-tight font-['Inter']">Ishwari Jamodkar</h1>
      <p className="text-lg mb-4 text-teal-200 font-['Roboto']">Full-Stack Developer | MERN</p>
